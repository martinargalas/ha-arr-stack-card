[Skip to main content](https://developers.home-assistant.io/docs/creating_integration_manifest/#__docusaurus_skipToContent_fallback)
...
## Domain [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#domain "Direct link to Domain")
...
## Name [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#name "Direct link to Name")
...
## Version [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#version "Direct link to Version")
...
## Integration type [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#integration-type "Direct link to Integration type")
...
| `virtual` | Not an integration on its own. Instead it points towards another integration or IoT standard. See [virtual integration](https://developers.home-assistant.io/docs/creating_integration_manifest/#virtual-integration) section. |
...
## Documentation [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#documentation "Direct link to Documentation")
...
## Issue tracker [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#issue-tracker "Direct link to Issue tracker")
...
## Dependencies [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#dependencies "Direct link to Dependencies")

Dependencies are other Home Assistant integrations you want Home Assistant to set up successfully before the integration is loaded. Adding an integration to dependencies will ensure the depending integration is loaded before setup, but it does not guarantee all dependency configuration entries have been set up. Adding dependencies can be necessary if you want to offer functionality from that other integration, like webhooks or an MQTT connection. Adding an [after dependency](https://developers.home-assistant.io/docs/creating_integration_manifest/#after-dependencies) might be a better alternative if a dependency is optional but not critical. See the [MQTT section](https://developers.home-assistant.io/docs/creating_integration_manifest/#mqtt) for more details on handling this for MQTT.
...
## After dependencies [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#after-dependencies "Direct link to After dependencies")
...
## Code owners [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#code-owners "Direct link to Code owners")
...
## Config flow [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#config-flow "Direct link to Config flow")
...
### Single config entry only [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#single-config-entry-only "Direct link to Single config entry only")
...
## Requirements [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#requirements "Direct link to Requirements")
...
### Custom requirements during development & testing [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#custom-requirements-during-development--testing "Direct link to Custom requirements during development & testing")
...
### Custom integration requirements [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#custom-integration-requirements "Direct link to Custom integration requirements")
...
## Loggers [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#loggers "Direct link to Loggers")
...
## Bluetooth [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#bluetooth "Direct link to Bluetooth")
...
## Zeroconf [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#zeroconf "Direct link to Zeroconf")
...
## SSDP [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#ssdp "Direct link to SSDP")
...
## HomeKit [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#homekit "Direct link to HomeKit")
...
## MQTT [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#mqtt "Direct link to MQTT")
...
If your integration requires `mqtt`, make sure it is added to the [dependencies](https://developers.home-assistant.io/docs/creating_integration_manifest/#dependencies).
...
## DHCP [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#dhcp "Direct link to DHCP")
...
## USB [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#usb "Direct link to USB")
...
## Integration quality scale [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#integration-quality-scale "Direct link to Integration quality scale")

The [Integration Quality Scale](https://developers.home-assistant.io/docs/core/integration-quality-scale) scores an integration on the code quality and user experience. Each level of the quality scale consists of a list of requirements. If an integration matches all requirements, it's considered to have reached that level.

New integrations are required to fulfill at least the bronze tier so be sure to look at the [Integration Quality Scale](https://developers.home-assistant.io/docs/core/integration-quality-scale) list of requirements. It helps to improve the code and user experience tremendously.
...
## IoT class [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#iot-class "Direct link to IoT class")

The [IoT class](https://www.home-assistant.io/blog/2016/02/12/classifying-the-internet-of-things/#classifiers) describes how an integration connects with, e.g., a device or service. For more information
about IoT Classes, read the blog about ["Classifying the Internet of Things"](https://www.home-assistant.io/blog/2016/02/12/classifying-the-internet-of-things/#classifiers).
...
## Virtual integration [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#virtual-integration "Direct link to Virtual integration")
...
### Supported by [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#supported-by "Direct link to Supported by")
...
### IoT standards [​](https://developers.home-assistant.io/docs/creating_integration_manifest/\#iot-standards "Direct link to IoT standards")
...
Brands also [support setting IoT standards](https://developers.home-assistant.io/docs/creating_integration_brand/#iot-standards).
...
- [Name](https://developers.home-assistant.io/docs/creating_integration_manifest/#name)
- [Version](https://developers.home-assistant.io/docs/creating_integration_manifest/#version)
- [Integration type](https://developers.home-assistant.io/docs/creating_integration_manifest/#integration-type)
- [Documentation](https://developers.home-assistant.io/docs/creating_integration_manifest/#documentation)
- [Issue tracker](https://developers.home-assistant.io/docs/creating_integration_manifest/#issue-tracker)
- [Dependencies](https://developers.home-assistant.io/docs/creating_integration_manifest/#dependencies)
- [After dependencies](https://developers.home-assistant.io/docs/creating_integration_manifest/#after-dependencies)
- [Code owners](https://developers.home-assistant.io/docs/creating_integration_manifest/#code-owners)
- [Config flow](https://developers.home-assistant.io/docs/creating_integration_manifest/#config-flow)
  - [Single config entry only](https://developers.home-assistant.io/docs/creating_integration_manifest/#single-config-entry-only)
- [Requirements](https://developers.home-assistant.io/docs/creating_integration_manifest/#requirements)
  - [Custom requirements during development & testing](https://developers.home-assistant.io/docs/creating_integration_manifest/#custom-requirements-during-development--testing)
  - [Custom integration requirements](https://developers.home-assistant.io/docs/creating_integration_manifest/#custom-integration-requirements)
- [Loggers](https://developers.home-assistant.io/docs/creating_integration_manifest/#loggers)
- [Bluetooth](https://developers.home-assistant.io/docs/creating_integration_manifest/#bluetooth)
- [Zeroconf](https://developers.home-assistant.io/docs/creating_integration_manifest/#zeroconf)
- [SSDP](https://developers.home-assistant.io/docs/creating_integration_manifest/#ssdp)
- [HomeKit](https://developers.home-assistant.io/docs/creating_integration_manifest/#homekit)
- [MQTT](https://developers.home-assistant.io/docs/creating_integration_manifest/#mqtt)
- [DHCP](https://developers.home-assistant.io/docs/creating_integration_manifest/#dhcp)
- [USB](https://developers.home-assistant.io/docs/creating_integration_manifest/#usb)
- [Integration quality scale](https://developers.home-assistant.io/docs/creating_integration_manifest/#integration-quality-scale)
- [IoT class](https://developers.home-assistant.io/docs/creating_integration_manifest/#iot-class)
- [Virtual integration](https://developers.home-assistant.io/docs/creating_integration_manifest/#virtual-integration)
  - [Supported by](https://developers.home-assistant.io/docs/creating_integration_manifest/#supported-by)
  - [IoT standards](https://developers.home-assistant.io/docs/creating_integration_manifest/#iot-standards)