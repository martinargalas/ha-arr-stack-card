// Prowlarr: the poster tiles in the right column and the click that opens the
// modal. Core, because the column draws them synchronously; the modal loads on
// demand (chunks/prowlarr.js).

class _ProwlarrTilesMethods {
...
export const prowlarrTilesMixin = _ProwlarrTilesMethods.prototype;
