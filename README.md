...
Rows in the qBittorrent, Deluge, rTorrent, Transmission, SABnzbd and NZBGet lists are matched back to the movie or episode they belong to, so clicking one opens that title's detail popup with its poster and description — no need to read a release name to work out what is downloading.
